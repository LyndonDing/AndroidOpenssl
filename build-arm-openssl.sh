...
# or ANDROID_NDK_ROOT=/usr/local/android-ndk-r8e./Users/Lyndon/Library/Android/sdk
...
export OPENSSLDIR="/usr/local/ssl/$ANDROID_API/"
...
./config shared no-ssl2 no-ssl3 no-comp no-hw no-engine --openssldir=$OPENSSLDIR/arm
